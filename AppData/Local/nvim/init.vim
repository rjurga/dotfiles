...
function! VisualStudioBuildSolution() abort
    let solution_file = trim(system('powershell -Command "try { [runtime.interopservices.marshal]::getactiveobject(''VisualStudio.DTE'').Solution.FullName } catch {}"'))
